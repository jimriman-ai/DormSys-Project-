...
| DEBT-W3-01 | CheckIn does not advance Request `checked_in`/`checked_out` | Completion Wave 3 W3-B | Wire CheckIn→Request vs park | Lead | Post W3-B | **OPEN — REGISTERED** | States+events+mutators delivered; consumer deferred. See `docs/audit/wave3-debt-discovery.md`. |
