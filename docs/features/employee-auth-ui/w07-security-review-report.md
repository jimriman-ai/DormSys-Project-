...
| F-W07-04 | **CARRIED FORWARD** — product authorization gate; **target: F3 Sprint A (or later)** (Lead-Advisory 2026-07-15; see `docs/governance/open-decisions.md` § F-W07-04). Canonical ID retained — no W-09 renumber. | Post-login surface catalog for next UI slug |
