<!-- Canonical path: `.specify/docs/decisions/domain-structure-evidence-consolidation-gate.md` -->
<!-- This file is a mirror pointer for `docs/decisions/` consumers. Prefer the .specify path. -->
