...
| ---- | ------------------- |
| `spec02` Identity & Access | **Frozen — Wave 1A Complete** (2026-06-26); bounded packet `SPEC02_DORMITORY_STRUCTURE_AUTHORIZATION_BINDING_COMPLETED` (2026-07-13) — does **not** unfreeze Spec02 |
