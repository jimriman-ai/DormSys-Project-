...
use App\Modules\Reporting\Infrastructure\Adapters\ExportSnapshotAssemblyAdapter;
...
class ReportingServiceProvider extends ServiceProvider
{
    public function register(): void
    {
        ...
        $this->app->singleton(QueryComplianceExportAction::class);
        $this->app->singleton(CorrelationProjectionQueryPort::class, CorrelationProjectionQueryAdapter::class);
        $this->app->singleton(ExportSnapshotAssemblyPort::class, ExportSnapshotAssemblyAdapter::class);
