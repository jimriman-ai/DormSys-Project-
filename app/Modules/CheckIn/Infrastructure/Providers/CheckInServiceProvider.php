...
use App\Modules\CheckIn\Infrastructure\Adapters\AllocationAssignmentReadAdapter;
...
class CheckInServiceProvider extends ServiceProvider
{
    public function register(): void
    {
        ...
        $this->app->singleton(AllocationAssignmentReadPort::class, AllocationAssignmentReadAdapter::class);
